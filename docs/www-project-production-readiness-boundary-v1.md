...
| [`www-project-phase-53-public-lifecycle-api-spec-plan-v1.md`](./www-project-phase-53-public-lifecycle-api-spec-plan-v1.md) | 規劃：公開生命週期 API 端點、收集中隱私回應、錯誤模型（**僅文件，非實作**；基準 `6d71358`） |
