...
export const CREATE_POLL_FAILURE_MESSAGE = PUBLIC_CREATE_POLL_FAILURE_MESSAGE;
const SAFE_FAILURE_MESSAGE = CREATE_POLL_FAILURE_MESSAGE;

export const CREATE_POLL_USER_ERROR_MESSAGES = PUBLIC_CREATE_POLL_USER_ERROR_MESSAGES;
...
export const CREATE_POLL_LIVE_SUBMIT_STATUS_LABEL =
  PUBLIC_CREATE_POLL_LIVE_SUBMIT_STATUS_LABEL;
export const CREATE_POLL_SUBMIT_PENDING_MESSAGE = PUBLIC_CREATE_POLL_SUBMIT_PENDING_MESSAGE;
...
export function normalizeCreatePollForm({ title, description = '', options }) {
  ...
  if (!normalizedTitle) {
    throw new Error(PUBLIC_CREATE_POLL_TITLE_REQUIRED_MESSAGE);
  }
  if (normalizedOptions.length < 2) {
    throw new Error(PUBLIC_CREATE_POLL_MIN_OPTIONS_MESSAGE);
  }
  if (normalizedOptions.length > MAX_OPTIONS) {
    throw new Error(PUBLIC_CREATE_POLL_MAX_OPTIONS_MESSAGE);
  }
