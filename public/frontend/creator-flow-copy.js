...
export const CREATOR_ONBOARDING_MESSAGES = PUBLIC_CREATOR_ONBOARDING_MESSAGES;
...
export function renderCreatorActionGuide(host, lifecycleState) {
  ...
  guide.setAttribute('aria-label', PUBLIC_CREATOR_ACTION_GUIDE_ARIA_LABEL);

  appendText(guide, 'h3', PUBLIC_CREATOR_ACTION_GUIDE_TITLE, 'mvp-creator-flow-guide-title');
...
export function renderCreateSuccessFlowGuide(host) {
  ...
  block.setAttribute('aria-label', PUBLIC_CREATOR_NEXT_STEPS_ARIA_LABEL);

  appendText(block, 'h3', PUBLIC_CREATOR_NEXT_STEPS_TITLE, 'mvp-creator-flow-next-steps-title');
