...
/** Frontend-owned login form state copy. */
export const PUBLIC_LOGIN_FORM_LOADING_MESSAGE = '登入中，請稍候。';
export const PUBLIC_LOGIN_FORM_MISSING_CREDENTIAL_MESSAGE = '請輸入登入憑證。';
export const PUBLIC_LOGIN_FORM_FAILURE_MESSAGE = '登入失敗，請確認憑證後再試。';
export const PUBLIC_LOGIN_FORM_ORIGIN_FAILURE_MESSAGE =
  '無法從目前頁面完成登入，請重新整理後再試。';
export const PUBLIC_LOGIN_FORM_NETWORK_FAILURE_MESSAGE =
  '網路連線失敗，請稍後再試。';
export const PUBLIC_LOGIN_FORM_VERIFY_STATE_FAILURE_MESSAGE =
  '登入已送出，但目前無法確認登入狀態，請重新整理後再試。';

/** Frontend-owned registration form state copy. */
export const PUBLIC_REGISTRATION_FORM_LOADING_MESSAGE = '註冊中，請稍候。';
export const PUBLIC_REGISTRATION_DISPLAY_NAME_MESSAGE = '請輸入顯示名稱。';
export const PUBLIC_REGISTRATION_BIRTH_YEAR_MONTH_MESSAGE =
  '請以 YYYY-MM 格式輸入出生年月。';
export const PUBLIC_REGISTRATION_REGION_MESSAGE = '請選擇居住地區。';
export const PUBLIC_REGISTRATION_CREDENTIAL_MESSAGE = '請輸入註冊憑證。';
export const PUBLIC_REGISTRATION_VALIDATION_FAILURE_MESSAGE =
  '請確認顯示名稱、出生年月與居住地區格式。';
export const PUBLIC_REGISTRATION_AUTH_FAILURE_MESSAGE =
  '註冊憑證無法通過驗證，請確認後再試。';
export const PUBLIC_REGISTRATION_ORIGIN_FAILURE_MESSAGE =
  '無法從目前頁面完成註冊，請重新整理後再試。';
export const PUBLIC_REGISTRATION_CONFLICT_MESSAGE =
  '此憑證已完成註冊，請直接前往登入。';
export const PUBLIC_REGISTRATION_UNAVAILABLE_MESSAGE =
  '目前尚未開放註冊，請稍後再試。';
export const PUBLIC_REGISTRATION_NETWORK_FAILURE_MESSAGE =
  '網路連線失敗，請稍後再試。';
export const PUBLIC_REGISTRATION_FAILURE_MESSAGE =
  '目前無法完成註冊，請稍後再試。';

/** Frontend-owned profile form state copy. */
export const PUBLIC_PROFILE_FORM_SAVING_MESSAGE = '儲存中，請稍候。';
export const PUBLIC_PROFILE_VALIDATION_MESSAGE =
  '請確認出生年月與居住地區格式。';
...
/** Frontend-owned create-poll form submit pending copy. */
export const PUBLIC_CREATE_POLL_SUBMIT_PENDING_MESSAGE = '建立中，請稍候。';

/** Frontend-owned create-poll form failure / validation copy. */
export const PUBLIC_CREATE_POLL_FAILURE_MESSAGE = '目前無法建立問卷，請稍後再試。';
export const PUBLIC_CREATE_POLL_TITLE_REQUIRED_MESSAGE = '請填寫問卷標題。';
export const PUBLIC_CREATE_POLL_MIN_OPTIONS_MESSAGE = '請至少填寫兩個選項。';
export const PUBLIC_CREATE_POLL_MAX_OPTIONS_MESSAGE = '選項最多六個。';

/** Frontend-owned creator session unavailable copy. */
export const PUBLIC_CREATOR_SESSION_FAILURE_MESSAGE =
  '目前無法確認發起者身分，請稍後再試。';

/** Allowlist of safe user-visible create-poll form error messages. */
export const PUBLIC_CREATE_POLL_USER_ERROR_MESSAGES = [
  PUBLIC_CREATE_POLL_FAILURE_MESSAGE,
  PUBLIC_CREATE_POLL_TITLE_REQUIRED_MESSAGE,
...
/** Allowlist of safe user-visible login / registration / profile state messages. */
export const PUBLIC_AUTH_STATE_USER_MESSAGES = [
  PUBLIC_LOGIN_FORM_LOADING_MESSAGE,
  PUBLIC_LOGIN_FORM_MISSING_CREDENTIAL_MESSAGE,
  PUBLIC_LOGIN_FORM_FAILURE_MESSAGE,
  PUBLIC_LOGIN_FORM_ORIGIN_FAILURE_MESSAGE,
  PUBLIC_LOGIN_FORM_NETWORK_FAILURE_MESSAGE,
...
/** Frontend-owned share-link section titles across public surfaces. */
export const PUBLIC_VOTE_PAGE_SHARE_SECTION_TITLE = '分享投票連結';
export const PUBLIC_RESULTS_PAGE_SHARE_SECTION_TITLE = '分享連結';
export const PUBLIC_CREATOR_OWNED_POLL_SHARE_SECTION_TITLE = '分享投票連結';
...
/** Allowlist of safe user-visible poll-creation / my-polls state messages. */
export const PUBLIC_CREATOR_STATE_USER_MESSAGES = [
  PUBLIC_CREATE_POLL_SUBMIT_PENDING_MESSAGE,
  PUBLIC_CREATE_POLL_FAILURE_MESSAGE,
  PUBLIC_CREATE_POLL_TITLE_REQUIRED_MESSAGE,
  PUBLIC_CREATE_POLL_MIN_OPTIONS_MESSAGE,
