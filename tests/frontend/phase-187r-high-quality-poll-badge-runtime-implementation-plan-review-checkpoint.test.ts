...
describe('Phase 187-R high-quality poll badge runtime implementation plan review checkpoint', () => {
  it('documents Phase 187 plan review and Phase 188 minimal public read runtime approval', async () => {
    ...
    expect(doc).toContain('Phase 187-R');
    expect(doc).toContain('Phase 187');
    expect(doc).toContain('APPROVED — Phase 188 blockers: none identified.');
    expect(doc).toContain('High-quality Poll Badge Minimal Public Read Runtime');
